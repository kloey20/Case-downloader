...
# Set your hardware limit here! 
# 3 is a very safe number for a standard laptop. 
# If you have a powerful desktop, you could bump this to 5 or 8.
MAX_CONCURRENT_BROWSERS = 3

def process_worker():
    """Continuously runs in the background, processing cases."""
    while True:
        task_id, case_num, folder = task_queue.get()
        if task_id is None: break
        
        batch_tasks[task_id]['status'] = 'processing'
        # Each worker creates its own isolated Edge browser
